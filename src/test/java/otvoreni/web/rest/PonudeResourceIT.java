...
class PonudeResourceIT {
    ...
    public static Ponude createEntity(EntityManager em) {
        Ponude ponude = new Ponude().sifraPonude(DEFAULT_SIFRA_PONUDE);
        return ponude;
    }
    ...
    public static Ponude createUpdatedEntity(EntityManager em) {
        Ponude ponude = new Ponude().sifraPonude(UPDATED_SIFRA_PONUDE);
        return ponude;
    }
    ...
    void putNewPonude() throws Exception {
        ...
        updatedPonude.sifraPonude(UPDATED_SIFRA_PONUDE);
